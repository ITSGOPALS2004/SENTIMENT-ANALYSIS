...
const Welcome: React.FC = () => {
    return (
        <div className="text-center py-12 px-6 flex flex-col items-center justify-center h-full">
            ...
            <h2 className="mt-4 text-2xl font-semibold text-gray-200">Ready to Analyze</h2>
            <p className="mt-2 max-w-md text-gray-400">
                Enter customer feedback, a product review, or any text into the box above and click 'Analyze' to see a detailed sentiment breakdown.
            </p>
        </div>
    );
};
